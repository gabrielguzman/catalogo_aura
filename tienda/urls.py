...
urlpatterns = [
    ...
    path('carrito/eliminar/<int:variante_id>/', views.eliminar_del_carrito, name='eliminar_carrito'),
    path('carrito/sumar/<int:variante_id>/', views.sumar_carrito, name='sumar_carrito'),
    path('carrito/restar/<int:variante_id>/', views.restar_carrito, name='restar_carrito'),
